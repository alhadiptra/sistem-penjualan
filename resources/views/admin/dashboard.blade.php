...
.sidebar .nav-link.active { background: linear-gradient(135deg, #ff69b4, #d63384); color: white; }
    ...
    <div class="row">
        <div class="col-md-2 sidebar">
            <nav class="nav flex-column">
                <a class="nav-link active" href="{{ route('admin.dashboard') }}"><i class="fas fa-chart-pie"></i> Dashboard</a>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="stat-card d-flex align-items-center">
                        ...
                        <div><div class="number">{{ $totalCustomers ?? 0 }}</div><div class="label">Total Pelanggan</div></div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-card d-flex align-items-center">
