    ...
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('owner.products.create') }}" class="btn btn-pink">
                            ...
                            <tbody>
                                @forelse($products as $key => $product)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('owner.products.edit', $product) }}" class="btn btn-outline-pink btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button"
                                                    class="btn btn-outline-danger btn-sm"
                                                    onclick="confirmDelete('{{ route('owner.products.destroy', $product) }}', '{{ $product->nama_produk }}')">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-4 text-muted">
                                            ...
                                            Belum ada produk. <a href="{{ route('owner.products.create') }}">Tambah sekarang</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
