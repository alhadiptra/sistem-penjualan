...
<head>
    <meta charset="UTF-8">
    <title>Laporan Harian - MochiHaanShop</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="header">
        ...
        <div class="date">Periode: {{ date('d F Y', strtotime($tanggal)) }}</div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width:14%;">Kecamatan</th> <!-- ✅ TAMBAHKAN -->
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="8" class="text-center" style="padding:30px;">Tidak ada pesanan pada tanggal ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
